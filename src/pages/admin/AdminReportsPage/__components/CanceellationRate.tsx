...
const CancellationRate = ({ dateRangeLabel, onToast }: Props) => {
      ...
      <div className="bg-white rounded-3xl border border-slate-100 p-6 shadow-sm space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-slate-50">
          ...
          <div className="flex gap-2">
            <button
              onClick={() => exportCSV("cancellation", EMPTY, "Cancellation Rate", (msg) => onToast(msg, "success"))}
            ...
            <button
              onClick={() => exportPDF("cancellation", EMPTY, "Cancellation Rate", dateRangeLabel, (msg) => onToast(msg, "info"), (msg) => onToast(msg, "success"))}
        ...
        <div className="py-16 text-center text-slate-400 font-medium text-sm">
          Cancellation analytics coming soon.
        </div>
      </div>
